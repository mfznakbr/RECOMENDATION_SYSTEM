...
Dataset yang digunakan dalam proyek ini berisi 2017 entri data, setelah di cek menggunakan fungsi info() ataupun menggunakan fungsi isna().sum() dataseti terlihat ini bersih dari missing value, untuk jumlah variabel atau fitur dataset ini terdiri dari 15 variabel numerik dan 2 variabel object. 
